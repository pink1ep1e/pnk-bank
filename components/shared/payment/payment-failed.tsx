...
export const PaymentFailed: React.FC<Props> = ({ 
    paymentId,
    amount,
    shopUrl,
    reason,
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-slate-50">
            <div className="flex flex-col items-center">
                ...
                <p className="text-[20px] text-slate-700 mb-1">В оплате было отказано создайте новый платеж</p>
                <p className="text-[20px] text-red-500 mb-4">Ошибка: {reason}</p>
                        ...
                        {isLoading ? (
                            ...
                            <div className="flex flex-col items-center gap-4 opacity-0 animate-fade-in">
                                <div className="rounded-[12px] drop-shadow-lg">
                                    <X size={80} className="text-white drop-shadow-sm" style={{ filter: 'drop-shadow(0 0 2px black)' }}/>
                                </div>
                                <span className="text-[35px] font-bold text-white drop-shadow-sm" style={{ textShadow: '0 0 2px black' }}>Оплата провалена</span>
                            </div>
                        )}
                    </div>
