...
export const NotificationDetails: React.FC<Props> = ({ className, notifications }) => {
    ...
    return (
        <div className={cn("shadow-md border-primary bg-white rounded-[20px] border border-slate-200 w-full h-[400px] lg:h-[320px] pt-[15px] pb-[15px] pr-[25px] pl-[25px] lg:pt-[25px] lg:pb-[25px] lg:pr-[35px] lg:pl-[35px]", className)}>
            <Title className="font-extrabold" text="Уведомления" size='md'/>
            <ScrollArea className="h-[320px] lg:h-[230px] pr-3">
