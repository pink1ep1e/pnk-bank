...
import { Crown, ChevronRight, BriefcaseBusiness } from "lucide-react";
...
export const AdminButton: React.FC<Props> = ({ className, role }) => {

    return (
        <>
        { role == "MODER" ?
            <a href="/cabinet/dashboard/banker" className={cn("flex cursor-pointer hover:bg-primary/5 rounded-[12px] p-2 justify-start mt-1 items-center gap-3", className)}>
                <div className="flex rounded-[16px] h-[55px] w-[55px] md:h-[60px] md:w-[60px] border border-primary/30 bg-white p-3 items-center justify-center">
                    <BriefcaseBusiness className="w-[25px] h-[25px] md:w-[30px] md:h-[30px]"/>
                </div>
                <div className="items-center"> 
                    <p className="text-[18px] lg:text-[20px] text-left font-regular">Работа</p>
                    <p className="text-[14px] lg:text-[18px] text-left font-regular text-[#434C55]">Войти в банкир-панель</p>
                </div>
