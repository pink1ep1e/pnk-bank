  ...
  return (
    <div>
        ...
        <div className={`mx-auto m-auto items-center justify-center flex flex-col p-12`} style={{ backgroundImage: "url('/landing/background.svg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
            <div className="flex justify-center fixed top-5 left-0 right-0 z-50 w-full h-24">
                <div className='flex w-fit border bg-white bg-gradient-to-br from-black/5 to-black/0 rounded-[22px] justify-between md:justify-center md:gap-10 items-center p-[13px] md:px-20 md:py-[13px] text-black'>
                    <div className="flex items-center font-semibold text-[22px] md:text-[42px] gap-2 select-none">
                        <h1>pnk</h1>
                        <h1>банк</h1>
                    </div>
                    ...
                    {/* Desktop Navigation */}
                    <div className="hidden md:flex items-center border gap-1 bg-white p-1.5 rounded-[20px] text-black transition-all font-medium text-[16px] md:text-[18px]">
                        <a className={`text-black py-[7px] px-5 rounded-[14px] transition-all ${backgroundColor === 'main-block' ? 'bg-black text-white hover:bg-black/100' : 'hover:bg-black/10'}`}  onClick={() => activeClick('main-block')} href="#main-block">Главная</a>
                        <a className={`text-black py-[7px] px-5 rounded-[14px] transition-all ${backgroundColor === 'info-block' ? 'bg-black text-white hover:bg-black/100' : 'hover:bg-black/10'}`} onClick={() => activeClick('info-block')} href="#info-block" >Информация</a>
                        <a className={`text-black py-[7px] px-5 rounded-[14px] transition-all ${backgroundColor === 'card-block' ? 'bg-black text-white hover:bg-black/100' : 'hover:bg-black/10'}`} onClick={() => activeClick('card-block')} href="#card-block" >Получение</a>
                        <a className={`text-black py-[7px] px-5 rounded-[14px] transition-all ${backgroundColor === 'application-block' ? 'bg-black text-white hover:bg-black/100' : 'hover:bg-black/10'}`} onClick={() => activeClick('application-block')} href="#application-block" >Приложение</a>
                    </div>
                    ...
                    {isMobileMenuOpen && (
                        <div className="absolute top-16 left-0 right-0 bg-white z-50 md:hidden p-4 shadow-lg">
                            <div className="flex flex-col gap-3 transition-all">
                                <a className="hover:text-white/80 p-2" href="#main-block">Главная</a>
                                <a className="hover:text-white/80 p-2" href="#cabinet-info">Информация</a>
                                <a className="hover:text-white/80 p-2" href="#location-block">Получение</a>
                                <a className="hover:text-white/80 p-2" href="">Приложение</a>
                            </div>
            ...
            <div id='main-block'>
                <div className='text-center leading-none mt-[120px]'>
                    <p className='text-[45px] text-black drop-shadow-lg mb-2'>Оформляй карту без комиссий</p>
                    <h1 className='text-[180px] font-bold text-black drop-shadow-lg'>Начни новую финансовую эпоху с нами!</h1>
                    <p className='text-[45px] text-black drop-shadow-lg mb-2'>Доступно с 06.06</p>
                </div>
        ...
        <div>
            <div className='container text-[140px] font-semibold mt-[100px] mb-[80px] px-[250px] flex flex-col leading-none justify-start'>
                <h1>Наши</h1>
            ...
            <div className='container m-auto mt-12 px-[180px] flex leading-none justify-start gap-12'>
                <div className='w-full h-[500px] bg-gradient-to-tr from-black/90 to-black/70 rounded-[25px]'>
                    <div className='p-8 text-white flex flex-col justify-center items-center h-full'>
                        <div className='flex-col text-center w-full'>
                            <p className='text-[25px]'>Новые условия</p>
                            <p className='text-[50px] font-bold'>Бесплатно</p>
                        </div>
                        <div className='flex flex-col w-[450px]'>
                            <div className='flex justify-center items-center gap-6 mt-8'>
                                ...
                                <div className=''>
                                    <p className='text-[25px] font-semibold mb-1'>Открытие и обслуживание</p>
                                    <p className='text-[20px] text-gray-50/90'>Все полностью бесплатно и без комиссий</p>
                                </div>
                            </div>
                            <div className='flex justify-center items-center gap-6 mt-8'>
                                <div className='w-[45px]'>
                                ...
                                <div className=''>
                                    <p className='text-[25px] font-semibold mb-1'>Использование карты</p>
                                    <p className='text-[20px] text-gray-50/90'>Пользуйтесь без ограничений где угодно и когда угодно</p>
                                </div>
                            </div>
                            <div className='flex justify-center items-center gap-6 mt-8'>
                                <div className='w-[45px]'>
                                    <HandCoins width={45} height={45}/>
                                </div>
                                <div className=''>
                                    <p className='text-[25px] font-semibold mb-1'>Оплата в магазинах и сервисах</p>
                                    <p className='text-[20px] text-gray-50/90'>Оплачивайте штрафы и услуги без комиссий</p>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className='w-full h-[500px] rounded-[25px] bg-center'>
            ...
            <div className='container m-auto mt-12 px-[180px] flex leading-none justify-start gap-12'>
                ...
                <div className='w-full h-[500px] border border-black bg-gradient-to-br from-black/5 to-black/0 rounded-[25px]'>
                    <div className='p-8 text-black flex flex-col justify-center items-center h-full'>
                        <div className='flex-col text-center w-full'>
                            <p className='text-[25px]'>Новые условия</p>
                            <p className='text-[50px] font-bold'>Без переплат</p>
                        </div>
                        <div className='flex flex-col w-[450px]'>
                            <div className='flex justify-center items-center gap-6 mt-8'>
                                <div className='w-[45px]'>
                                    <CircleHelp width={45} height={45}/>
                                </div>
                                <div className=''>
                                    <p className='text-[25px] font-semibold mb-1'>Поддержка и обслуживание</p>
                                    <p className='text-[20px] text-black/80'>Задавайте вопросы в поддержку в любое время</p>
                                </div>
                            </div>
                            <div className='flex justify-center items-center gap-6 mt-8'>
                                <div className='w-[45px]'>
                                    <Nfc width={45} height={45}/>
                                </div>
                                <div className='text-start'>
                                    <p className='text-[25px] font-semibold mb-1'>Оплачивайте услуги в mодуле</p>
                                    <p className='text-[20px] text-black/80'>Используя личный кабинет где бы вы не находились можете оплатить услуги</p>
                                </div>
                            </div>
                            <div className='flex justify-center items-center gap-6 mt-8'>
                                <div className='w-[45px]'>
                                ...
                                <div className=''>
                                    <p className='text-[25px] font-semibold mb-1'>А с услугами Premium </p>
                                    <p className='text-[20px] text-black/80'>Все станет еще проще, переводы без комиссий до 10 000, услуги без ограничений</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* БЛОК 3 */}
            <div className='container m-auto mt-12 px-[180px] flex leading-none justify-start gap-12'>
                <div className='w-full h-[500px] bg-gradient-to-bl from-black/90 to-black/70 rounded-[25px]'>
                    <div className='p-8 text-white flex flex-col justify-center items-center h-full'>
                        <div className='flex-col text-center w-full'>
                            <p className='text-[25px]'>Новые условия</p>
                            <p className='text-[50px] font-bold'>Удобно и просто</p>
                        </div>
                        <div className='flex flex-col w-[450px]'>
                            <div className='flex justify-center items-center gap-6 mt-8'>
                                <div className='w-[45px]'>
                                    <PanelBottomOpen width={45} height={45}/>
                                </div>
                                <div className=''>
                                    <p className='text-[25px] font-semibold mb-1'>Повышайте уровень</p>
                                    <p className='text-[20px] text-gray-50/90'>Переводите средства друзьям, повышайте уровень, и соревнуйтесь</p>
                                </div>
                            </div>
                            <div className='flex justify-center items-center gap-6 mt-8'>
                                <div className='w-[45px]'>
                                ...
                                <div className=''>
                                    <p className='text-[25px] font-semibold mb-1'>Безопастно переводите средства</p>
                                    <p className='text-[20px] text-gray-50/90'>Удобная система поиска по получателю не даст вам потерять деньги</p>
                                </div>
                            </div>
                            <div className='flex justify-center items-center gap-6 mt-8'>
                                <div className='w-[45px]'>
                                ...
                                <div className=''>
                                    <p className='text-[25px] font-semibold mb-1'>Настваивайте все под себя</p>
                                    <p className='text-[20px] text-gray-50/90'>Настройте подходящие условия для вашего бизнеса</p>
                                </div>
                            </div>
                        </div>
                    </div>
       ...
       <div>
            <div className='container text-[140px] mt-[150px] mb-[80px] font-semibold px-[250px] flex flex-col leading-none justify-start'>
                <h1>Заказ</h1>
            ...
            <div className='container m-auto mt-12 px-[180px] flex leading-none justify-start gap-12'>
                {/* БЛОК 1 */}
                <div className='w-full h-[500px] bg-gradient-to-bl from-black/90 to-black/70 rounded-[25px] relative'>
                ...
                {/* БЛОК 2 */}
                <div className='w-full h-[500px] border border-black bg-gradient-to-br from-black/5 to-black/0 rounded-[25px] relative'>
                    <div className='px-8 flex-col text-[42px] text-black py-6 flex justify-center items-center h-full'>
                        <div className='absolute -top-1/3 left-0 w-full h-full flex justify-center items-center'>
                            <Image 
        ...
        <div>
            ...
            <div className='container m-auto mt-12 px-[180px] flex leading-none justify-start gap-12'>
                {/* БЛОК 1 */}
                <div className='w-full h-[500px] border border-black bg-gradient-to-br from-black/5 to-black/0 rounded-[30px] relative'>
        ...
        <div id='developer-block'>
            ...
            <div className='container m-auto mt-12 px-[180px] flex leading-none justify-start gap-12'>
                {/* БЛОК 1 */}
                <div className='w-full h-[500px] bg-gradient-to-bl from-black/90 to-black/70 rounded-[30px] relative'>
                    <Image 
                ...
                {/* БЛОК 2 */}
                <div className='w-full -top-12 h-[500px] border border-black bg-gradient-to-br from-black/5 to-black/0 rounded-[30px] relative'>
                    <Image 
                ...
                {/* БЛОК 3 */}
                <div className='w-full h-[500px] border border-black bg-gradient-to-bl from-black/90 to-black/70 rounded-[30px] relative'>
